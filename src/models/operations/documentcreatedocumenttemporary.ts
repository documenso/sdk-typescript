 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DocumentCreateDocumentTemporaryTypeLink$ {
  /** @deprecated use `DocumentCreateDocumentTemporaryTypeLink$inboundSchema` instead. */
  export const inboundSchema =
    DocumentCreateDocumentTemporaryTypeLink$inboundSchema;
  /** @deprecated use `DocumentCreateDocumentTemporaryTypeLink$outboundSchema` instead. */
  export const outboundSchema =
    DocumentCreateDocumentTemporaryTypeLink$outboundSchema;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DocumentCreateDocumentTemporaryAttachment$ {
  /** @deprecated use `DocumentCreateDocumentTemporaryAttachment$inboundSchema` instead. */
  export const inboundSchema =
    DocumentCreateDocumentTemporaryAttachment$inboundSchema;
  /** @deprecated use `DocumentCreateDocumentTemporaryAttachment$outboundSchema` instead. */
  export const outboundSchema =
    DocumentCreateDocumentTemporaryAttachment$outboundSchema;
  /** @deprecated use `DocumentCreateDocumentTemporaryAttachment$Outbound` instead. */
  export type Outbound = DocumentCreateDocumentTemporaryAttachment$Outbound;
}
