...
export type DocumentCreateDocumentTemporaryDocument = {
...
/** @internal */
export const DocumentCreateDocumentTemporaryDocument$inboundSchema: z.ZodType<
...
/** @internal */
export type DocumentCreateDocumentTemporaryDocument$Outbound = {
  visibility: string;
  status: string;
  source: string;
  id: number;
...
/** @internal */
export const DocumentCreateDocumentTemporaryDocument$outboundSchema: z.ZodType<
  DocumentCreateDocumentTemporaryDocument$Outbound,
  z.ZodTypeDef,
  DocumentCreateDocumentTemporaryDocument
> = z.object({
...
export function documentCreateDocumentTemporaryDocumentToJSON(
  documentCreateDocumentTemporaryDocument:
    DocumentCreateDocumentTemporaryDocument,
): string {
  return JSON.stringify(
    DocumentCreateDocumentTemporaryDocument$outboundSchema.parse(
      documentCreateDocumentTemporaryDocument,
    ),
  );
}
export function documentCreateDocumentTemporaryDocumentFromJSON(
  jsonString: string,
): SafeParseResult<
  DocumentCreateDocumentTemporaryDocument,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      DocumentCreateDocumentTemporaryDocument$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'DocumentCreateDocumentTemporaryDocument' from JSON`,
  );
}
...
export const DocumentCreateDocumentTemporaryResponse$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  document: z.lazy(() => DocumentCreateDocumentTemporaryDocument$inboundSchema),
  uploadUrl: z.string(),
});
/** @internal */
export type DocumentCreateDocumentTemporaryResponse$Outbound = {
  document: DocumentCreateDocumentTemporaryDocument$Outbound;
  uploadUrl: string;
};
...
> = z.object({
  document: z.lazy(() =>
    DocumentCreateDocumentTemporaryDocument$outboundSchema
  ),
  uploadUrl: z.string(),
});
