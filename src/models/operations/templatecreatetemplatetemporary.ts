 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace TemplateCreateTemplateTemporaryTypeLink$ {
  /** @deprecated use `TemplateCreateTemplateTemporaryTypeLink$inboundSchema` instead. */
  export const inboundSchema =
    TemplateCreateTemplateTemporaryTypeLink$inboundSchema;
  /** @deprecated use `TemplateCreateTemplateTemporaryTypeLink$outboundSchema` instead. */
  export const outboundSchema =
    TemplateCreateTemplateTemporaryTypeLink$outboundSchema;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace TemplateCreateTemplateTemporaryAttachment$ {
  /** @deprecated use `TemplateCreateTemplateTemporaryAttachment$inboundSchema` instead. */
  export const inboundSchema =
    TemplateCreateTemplateTemporaryAttachment$inboundSchema;
  /** @deprecated use `TemplateCreateTemplateTemporaryAttachment$outboundSchema` instead. */
  export const outboundSchema =
    TemplateCreateTemplateTemporaryAttachment$outboundSchema;
  /** @deprecated use `TemplateCreateTemplateTemporaryAttachment$Outbound` instead. */
  export type Outbound = TemplateCreateTemplateTemporaryAttachment$Outbound;
}
