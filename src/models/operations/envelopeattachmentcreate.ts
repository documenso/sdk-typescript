 ...
 * Successful response
 */
export type EnvelopeAttachmentCreateResponse = {
  id: string;
};
...
/** @internal */
export const EnvelopeAttachmentCreateResponse$inboundSchema: z.ZodType<
...
/** @internal */
export type EnvelopeAttachmentCreateResponse$Outbound = {
  id: string;
};

/** @internal */
export const EnvelopeAttachmentCreateResponse$outboundSchema: z.ZodType<
  EnvelopeAttachmentCreateResponse$Outbound,
  z.ZodTypeDef,
  EnvelopeAttachmentCreateResponse
> = z.object({
  id: z.string(),
...
export function envelopeAttachmentCreateResponseToJSON(
  envelopeAttachmentCreateResponse: EnvelopeAttachmentCreateResponse,
): string {
  return JSON.stringify(
    EnvelopeAttachmentCreateResponse$outboundSchema.parse(
      envelopeAttachmentCreateResponse,
    ),
  );
}
export function envelopeAttachmentCreateResponseFromJSON(
  jsonString: string,
): SafeParseResult<EnvelopeAttachmentCreateResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EnvelopeAttachmentCreateResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EnvelopeAttachmentCreateResponse' from JSON`,
  );
}
