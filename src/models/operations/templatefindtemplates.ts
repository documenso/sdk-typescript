 ...
 */
export namespace TemplateFindTemplatesQueryParamType$ {
  /** @deprecated use `TemplateFindTemplatesQueryParamType$inboundSchema` instead. */
  export const inboundSchema =
    TemplateFindTemplatesQueryParamType$inboundSchema;
  /** @deprecated use `TemplateFindTemplatesQueryParamType$outboundSchema` instead. */
  export const outboundSchema =
    TemplateFindTemplatesQueryParamType$outboundSchema;
}
