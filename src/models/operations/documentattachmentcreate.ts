 ...
 * Successful response
 */
export type DocumentAttachmentCreateResponse = {
  id: string;
};
...
/** @internal */
export const DocumentAttachmentCreateResponse$inboundSchema: z.ZodType<
...
/** @internal */
export type DocumentAttachmentCreateResponse$Outbound = {
  id: string;
};

/** @internal */
export const DocumentAttachmentCreateResponse$outboundSchema: z.ZodType<
  DocumentAttachmentCreateResponse$Outbound,
  z.ZodTypeDef,
  DocumentAttachmentCreateResponse
> = z.object({
  id: z.string(),
...
export function documentAttachmentCreateResponseToJSON(
  documentAttachmentCreateResponse: DocumentAttachmentCreateResponse,
): string {
  return JSON.stringify(
    DocumentAttachmentCreateResponse$outboundSchema.parse(
      documentAttachmentCreateResponse,
    ),
  );
}
export function documentAttachmentCreateResponseFromJSON(
  jsonString: string,
): SafeParseResult<DocumentAttachmentCreateResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DocumentAttachmentCreateResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DocumentAttachmentCreateResponse' from JSON`,
  );
}
