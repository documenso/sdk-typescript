...
export type DocumentFindDocumentsRecipientsAuthOptions = {
  /**
   * The type of authentication required for the recipient to access the document.
   */
...
export type DocumentFindDocumentsRecipients = {
  ...
  authOptions: DocumentFindDocumentsRecipientsAuthOptions | null;
  /**
...
/** @internal */
export const DocumentFindDocumentsRecipientsAuthOptions$inboundSchema:
  z.ZodType<DocumentFindDocumentsRecipientsAuthOptions, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export type DocumentFindDocumentsRecipientsAuthOptions$Outbound = {
  accessAuth: string | null;
  actionAuth: string | null;
};

/** @internal */
export const DocumentFindDocumentsRecipientsAuthOptions$outboundSchema:
  z.ZodType<
    DocumentFindDocumentsRecipientsAuthOptions$Outbound,
    z.ZodTypeDef,
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DocumentFindDocumentsRecipientsAuthOptions$ {
  /** @deprecated use `DocumentFindDocumentsRecipientsAuthOptions$inboundSchema` instead. */
  export const inboundSchema =
    DocumentFindDocumentsRecipientsAuthOptions$inboundSchema;
  /** @deprecated use `DocumentFindDocumentsRecipientsAuthOptions$outboundSchema` instead. */
  export const outboundSchema =
    DocumentFindDocumentsRecipientsAuthOptions$outboundSchema;
  /** @deprecated use `DocumentFindDocumentsRecipientsAuthOptions$Outbound` instead. */
  export type Outbound = DocumentFindDocumentsRecipientsAuthOptions$Outbound;
}

export function documentFindDocumentsRecipientsAuthOptionsToJSON(
  documentFindDocumentsRecipientsAuthOptions:
    DocumentFindDocumentsRecipientsAuthOptions,
): string {
  return JSON.stringify(
    DocumentFindDocumentsRecipientsAuthOptions$outboundSchema.parse(
      documentFindDocumentsRecipientsAuthOptions,
    ),
  );
}

export function documentFindDocumentsRecipientsAuthOptionsFromJSON(
  jsonString: string,
): SafeParseResult<
  DocumentFindDocumentsRecipientsAuthOptions,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      DocumentFindDocumentsRecipientsAuthOptions$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'DocumentFindDocumentsRecipientsAuthOptions' from JSON`,
  );
}
...
> = z.object({
  ...
  authOptions: z.nullable(
    z.lazy(() => DocumentFindDocumentsRecipientsAuthOptions$inboundSchema),
  ),
...
export type DocumentFindDocumentsRecipients$Outbound = {
  ...
  expired: string | null;
  signedAt: string | null;
  authOptions: DocumentFindDocumentsRecipientsAuthOptions$Outbound | null;
  signingOrder: number | null;
  rejectionReason: string | null;
};
...
> = z.object({
  ...
  signedAt: z.nullable(z.string()),
  authOptions: z.nullable(
    z.lazy(() => DocumentFindDocumentsRecipientsAuthOptions$outboundSchema),
  ),
  signingOrder: z.nullable(z.number()),
  rejectionReason: z.nullable(z.string()),
});
