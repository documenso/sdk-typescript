...
export function documentsRecipientsUpdateMany(
  ...
  Result<
    ...
    | errors.RecipientUpdateDocumentRecipientsUnauthorizedError
    | errors.RecipientUpdateDocumentRecipientsForbiddenError
...
> {
  ...
  const path = pathToFunc("/document/recipient/update-many")();
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.RecipientUpdateDocumentRecipientsUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.RecipientUpdateDocumentRecipientsForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
