...
export async function fieldsGet(
  ...
  Result<
    operations.FieldGetFieldResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.FieldGetFieldRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.FieldGetFieldResponseBody$inboundSchema),
