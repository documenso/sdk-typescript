 ...
 */
export async function recipientsGet(
  client: DocumensoCore,
  request: operations.RecipientGetRecipientRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.RecipientGetRecipientResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RecipientGetRecipientRequest$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "recipient-getRecipient",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.RecipientGetRecipientResponseBody$inboundSchema),
