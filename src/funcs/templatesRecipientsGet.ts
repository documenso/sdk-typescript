 ...
 */
export function templatesRecipientsGet(
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RecipientGetTemplateRecipientResponse$inboundSchema),
    M.jsonErr(
      400,
    ...
    M.jsonErr(
      404,
      errors.RecipientGetTemplateRecipientNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.RecipientGetTemplateRecipientInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
