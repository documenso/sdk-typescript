 ...
 */
export function documentsFieldsDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.FieldDeleteDocumentFieldRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.FieldDeleteDocumentFieldResponse$inboundSchema),
    M.jsonErr(
      400,
