...
export function embeddingEmbeddingPresignCreateEmbeddingPresignToken(
  ...
  Result<
    ...
    | errors.EmbeddingPresignCreateEmbeddingPresignTokenUnauthorizedError
    | errors.EmbeddingPresignCreateEmbeddingPresignTokenForbiddenError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors
        .EmbeddingPresignCreateEmbeddingPresignTokenUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors
        .EmbeddingPresignCreateEmbeddingPresignTokenForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors
