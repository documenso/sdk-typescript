...
export function documentsRecipientsGet(
  ...
  Result<
    ...
    | errors.RecipientGetDocumentRecipientBadRequestError
    | errors.RecipientGetDocumentRecipientUnauthorizedError
    | errors.RecipientGetDocumentRecipientForbiddenError
    | errors.RecipientGetDocumentRecipientNotFoundError
    | errors.RecipientGetDocumentRecipientInternalServerError
    | DocumensoError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RecipientGetDocumentRecipientResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.RecipientGetDocumentRecipientBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.RecipientGetDocumentRecipientUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.RecipientGetDocumentRecipientForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.RecipientGetDocumentRecipientNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.RecipientGetDocumentRecipientInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
