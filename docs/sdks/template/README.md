...
* [templateCreateTemplate](#templatecreatetemplate) - Create template
...
async function run() {
  const result = await documenso.template.templateCreateTemplate({
    payload: {
      title: "<value>",
    },
    file: "<value>",
...
import { templateTemplateCreateTemplate } from "@documenso/sdk-typescript/funcs/templateTemplateCreateTemplate.js";
...
async function run() {
  const res = await templateTemplateCreateTemplate(documenso, {
    payload: {
      title: "<value>",
    },
    file: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("templateTemplateCreateTemplate failed:", res.error);
  }
}
