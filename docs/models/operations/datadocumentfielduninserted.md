...
```typescript
import { DataDocumentFieldUninserted } from "@documenso/sdk-typescript/models/operations";

let value: DataDocumentFieldUninserted = {
...
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `type`                                                                                         | *"DOCUMENT_FIELD_UNINSERTED"*                                                                  | :heavy_check_mark:                                                                             | N/A                                                                                            |
